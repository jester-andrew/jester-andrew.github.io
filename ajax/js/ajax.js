...
btn.addEventListener("click", getMountain);
...
function getMountainStats() {
    ...
    let str = '<ul>' +
        '<li>' + mountainObject.all[i].name + '</li>' +
        '<li> Elevation: ' + mountainObject.all[i].elevation + ' feet</li>' +
        '<li> Mountain Range: ' + mountainObject.all[i].range + '</li>' +
        '<li> Difficulty Level: ' + mountainObject.all[i].difficultyClass + '</li>' +
        '<li> Round Trip: ' + mountainObject.all[i].roundTripMiles + ' miles</li>' +
        '<li> More info: <a href="' + mountainObject.all[i].url + '">' + mountainObject.all[i].name + '</a></li>';
